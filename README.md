...
Resources
Official Docs
This Python Playlist is Sufficient for Data Analyst
Pandas Tutorials
...
Resources
Statistics for Data Analytics, Data Science & AI.
Complete Statistics for Data Science
Statistics Module of Data Analysis Specialization
...
Excel Module of Data Analysis Specialization
...
Resources
Power BI's tutorials.
PowerBi Module of Data Analysis Specialization
...
Tableau.
Google Data Studio.
Tableau/Looker Studio Module of Data Analysis Specialization
...
Resources
Statistical Machine Learning Playlist
...
Sales Trend Analysis: Use SQL and Tableau/PowerBi to analyze sales trends and visualize top-performing products.
Customer Segmentation: Perform clustering with Python (Pandas, Scikit-learn) and visualize results in Tableau/PowerBi.
Website Traffic Analysis: Analyze Google Analytics data with Excel and create dashboards in Looker Studio/Tableau/PowerBi.
Retail Inventory Optimization: Use R for inventory analysis and visualization to improve stock management.
Marketing Campaign Analysis: Evaluate campaign performance using Tableau/PowerBi and statistical analysis in Excel.
HR Attrition Dashboard: Build an interactive dashboard using Power BI with data insights from SQL.
Financial Statement Analysis: Perform financial ratio analysis in Excel and automate reporting with Python.
Logistics and Supply Chain Analysis: Use Tableau/PowerBi to visualize supply chain delays and SQL for querying data.
Customer Support Ticket Analysis: Analyze customer support trends with Python (Pandas, Matplotlib) and create KPIs in Power BI.
Stock Market Trend Analysis: Perform stock trend analysis using Python (yFinance, Matplotlib) and dashboards in Tableau.
Where to Find Data?
Kaggle
...
Clean and manipulate it using Python or Excel.
Analyze the data using Statistics.
Visualize insights with Power BI, Tableau, or Data Studio.
Showcase results in a project or portfolio.
...
SQL, Statistics & Data Analysis Tools
Basic to Advanced Python
Machine Learning & Data Science Core Concepts
